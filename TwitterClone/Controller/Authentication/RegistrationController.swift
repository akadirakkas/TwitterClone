...
//  TwitterClone
//
//  Created by AbdulKadir Akkaş on 22.08.2021.
//
...
class RegistrationController: UIViewController {
    ...
    @objc func handleRegistiration() {
        ...
        let credentialts = AuthCredentials(email: email, password: password, fullname: fullname, username: username, profileImage: profileImage)
        
        AuthService.shared.registerUser(credentials: credentialts) { error, ref in
    ...
    private let registirationButton: UIButton = {
        let button = UIButton(type: .system)
